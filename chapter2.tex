...
\newline A research titled ``Participation against competition in Banking Markets based on cognitive game theory``~\shortcite{Gilli2011337} studies the possibility of cooperation between micro capital market and banks. In addition they proposed a model for income calculation and allocation between banks.

In conclusion they found that banks could earn more profits if they co-operated instead of competing.\part{title}
