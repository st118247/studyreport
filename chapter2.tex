...
The case is applied to a scenario where the National Bank of Romania classifies NFI`s into ``good`` or ``poor`` depending on the periodic financial reporting. National Bank of Romania collects the financial reports from Non - Banking financial institutions and monitors the situation 
